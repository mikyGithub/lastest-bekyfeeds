            ...
            <div class="flex flex-col w-full">
                <div class="latest_post">
                    ...
                    if (is_array($episodesJson) || is_object($episodesJson)) {
                        ...
                        <div class="flex items-center justify-between p-4 font-bold text-white bg-green-800 border-b border-gray-800 ">
                        <div class=""> Download Links   <span class="text-white text-center"> ' . '</span> </div>
                ...
                <div class="text-sm text-gray-500 ">    <span class="text-green-500"> ' . $file . '</span> </div>
        </a>
        </div>';
