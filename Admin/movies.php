...
<body>
    <div class="flex py-3 mt-4 mb-6 bg-gray-200" style="border-bottom:1px #1D2861 dashed ">
        <a style="border:0px" href="movies.php"
            class="w-auto p-2 mx-3 bg-primary focus:outline-none hover:bg-white hover:text-black">Movies</a>
        <a style="border:0px" href="series.php"
            class="w-auto p-2 mx-3 bg-primary focus:outline-none hover:bg-white hover:text-black">Tv Shows</a>
        <a style="border:0px" href="newsfeeds.php"
            class="w-auto p-2 mx-3 bg-primary focus:outline-none hover:bg-white hover:text-black">News Feeds</a>
        <a style="border:0px" href="gamesfeeds.php"
            class="w-auto p-2 mx-3 bg-primary focus:outline-none hover:bg-white hover:text-black">Games Feeds</a>
    </div>
    <section style="border:1px #139ea8 solid" class="p-2 bg-white rounded">
        <div class="flex justify-between py-4 bg-white px-2">
            <div> Movies</div>
            <div>
                <button data-toggle="modal" data-target="#myModal" style="border:0px"
                    class="w-auto p-2 px-3 focus:outline-none bg-primary rounded text-white">
  ...
  <td class="p-3 text-center">
      ...
      <img alt="'. $movie["title"] .'" class="w-32 h-32" src="images/mposters/' . $movie["img_url"] . '" />
          <div class="pl-2">
    ...
    <div id="myModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                        ...
                        <form class="px-8 pt-6 pb-8 mb-4 bg-white rounded">
                            <div class="md:mb-4">
                                ...
                                <input
                                    ...
                                    id="name" type="text" placeholder="Movie Name" />
                            </div>
                            <div class="mb-4">
                                ...
                                <textarea
                                    ...
                                    id="description" type="email" placeholder="Description"></textarea>
                            </div>
                            <div class="mb-4">
                                <label class="block mb-2 text-sm font-bold text-gray-700" for="email">
                                    Releasing Year
                                ...
                                <input
                                    ...
                                    id="name" type="date" placeholder="Movie Name" />
                            </div>
                            <div class="md:mb-4">
                                ...
                                <select
                                    class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                    id="category" type="text" placeholder="Last Name">
                            ...
                            <div class="md:mb-4">
                                ...
                                <input
                                    class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                    id="name" type="radio" placeholder="Movie Name" />
                            </div>
                            <div class="mb-4">
                                <label class="block mb-2 text-sm font-bold text-gray-700" for="email">
                                    Image
                ...
                <div class="modal-footer">
                    <button
                        class="w-auto p-2 font-medium text-base float-right mx-3 bg-theme focus:outline-none hover:bg-white hover:text-black"
                        type="button">
                        Create
                    </button>
                </div>
